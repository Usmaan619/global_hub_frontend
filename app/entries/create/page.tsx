        ...
        <main className="flex-1 overflow-y-auto p-6">
          <div className="mx-auto">
            <div className="mb-6 flex items-center justify-between">
              <div>
                <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Create New Data Entry</h1>
                <p className="text-gray-600 dark:text-gray-300 mt-1">Fill in the details for your new entry.</p>
              </div>
